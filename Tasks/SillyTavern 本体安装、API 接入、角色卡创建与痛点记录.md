...
---
[[主流大模型API性价比调研任务]]
- [x] 完成 SillyTavern 本体安装、API 接入、角色卡创建与痛点记录 📅 2026-04-17 ✅ 2026-05-01
...
|                                                                                             |     |            |
| ------------------------------------------------------------------------------------------- | --- | ---------- |
| 更有性格，记忆的聊天，是否可以设置成真实的数字员工呢，角色+skill。<br>像龙虾那样？接入社交平台，像微信，qq。对话的ui窗口就是“真人”一样。<br>拟人操作，但是没有灰产 |     | 2026-05-01 |
| 它的价值是什么还是只是玩物                                                                               |     |            |
